...
export const metadata: Metadata = {
  ...
  description:
    'Premium barbershop in Jinja, Uganda. Master barber Ben Ozzly offers precision cuts, flawless fades, hot towel shaves, and expert beard grooming. Book via WhatsApp.',
